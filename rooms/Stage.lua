...
function Stage:new()
    self.area = Area(self)
    self.main_canvas = love.graphics.newCanvas(gw, gh)  -- our global width & height, (480,270)
    self.timer = Timer()
    --[[ if you decide to hold references returned by addGameObject like this,
    if you don't set the variable holding the reference to nil that object will never be collected. ]]
